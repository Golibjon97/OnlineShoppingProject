...
<thead>
	...
	%>
        ...
        <tbody>
        <%
      	ResultSet rs = st.executeQuery("select *from product inner join carts on product.id=carts.product_id and carts.email='"+email+"' and carts.address is NULL");
      	while(rs.next()){
  		 %>
          <tr>
          <%sno=sno+1;%>
...
<h3 style="color: red">*If you select online Payment then enter your transaction ID will be here otherwise leave this blank</h3>
</div>
<hr style="width: 100%">
