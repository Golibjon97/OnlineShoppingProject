...
<table id="customers">
    ...
    try{
    		...
    		ResultSet rs = st.executeQuery("select *from carts inner join product where carts.product_id=product.id and carts.orderDate is not NULL and carts.status='processing'");
    		while(rs.next()){
